...
class Order(db.Model):
    ...
    detail_ingredient = db.relationship('OrderDetailIngredient', backref=db.backref('order_detail_ingredient'))
    detail_beverage = db.relationship('OrderDetailBeverage', backref=db.backref('order_detail_beverage'))
...
class OrderDetailIngredient(db.Model):
    _id = db.Column(db.Integer, primary_key=True)
...
class OrderDetailBeverage(db.Model):
    _id = db.Column(db.Integer, primary_key=True)
